        ...
        array(
            ...
            from (select 
                ...
                from comment dc
                    ...
                    left join member fm on fm.id = dc.member_id
                    ...
                    left join school_role fsr on fm.school_role_id = fsr.id
                    left join member ttm on dc.target_member_id = ttm.id
                    left join schools tts on tts.id = ttm.school_id
                    left join class ttc on ttc.id = ttm.class_id
                    left join school_role ttsr on ttsr.id = ttm.school_role_id
